...
<html lang="en">
    ...
    <body>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="pl-0 border-0">
                        ...
                        @endif
                        <p>{{ __('invoices::invoice.invnum') }} <strong>{{ $invoice->getSerialNumber() }}</strong></p>
        ...
        <table class="table table-items">
            <thead>
                <tr>
                    <th scope="col" class="pl-0 border-0">{{ __('invoices::invoice.service') }}</th>
                    ...
                    <th scope="col" class="pr-0 text-right border-0"></th>
                </tr>
            </thead>
            <tbody>
                {{-- Items --}}
